...
public record Locale(
     ...
     * @param blockUnlockSettingsError The message sent to the player when a block unlock fails due to a settings error.
     * @param blockUnlockUserError The message sent to the player when a block unlock fails due to a LuckPerms' user error.
     * @param blockUnlockExcluded The message sent to the player when a block unlock fails due to being excluded from block unlocks.
     ...
     * @param playerBlockUnlockSettingsError The message sent to the player who tried to unlock a block for another player, but the unlocked failed due to invalid plugin settings.
     * @param playerBlockUnlockUserError The message sent to the player who tried to unlock a block for another player, but the unlocked failed due to a LuckPerms' user error.
     * @param playerBlockUnlockExcluded The message sent to the player who tried to unlock a block for another player, but the unlocked failed due to the player being excluded from block unlocks.
    ...
    public record WorldMineMessages(
            ...
            String blockUnlockSettingsError,
            String blockUnlockUserError,
            String blockUnlockExcluded,
            String blockLocked,
            String blocksLocked,
            String playerBlockUnlocked,
            String playerBlockUnlockSettingsError,
            String playerBlockUnlockUserError,
            String playerBlockUnlockExcluded,
