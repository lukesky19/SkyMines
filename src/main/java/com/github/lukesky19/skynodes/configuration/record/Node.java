...
@ConfigSerializable
public record Node(String configVersion, LinkedHashMap<String, LinkedHashMap<String, LinkedHashMap<Integer, NodeData>>> data) {
    @ConfigSerializable
    public record NodeData(
            String region,
            LinkedHashMap<Integer, BlockData> blocksAllowed) {}
