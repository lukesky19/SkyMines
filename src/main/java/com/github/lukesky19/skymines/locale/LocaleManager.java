...
*/
package com.github.lukesky19.skymines.locale;
...
public class LocaleManager extends SimpleConfigManager<Locale> {
    ...
    public void loadConfiguration() {
        ...
        configurationPath = Path.of(plugin.getDirectoryFile() + File.separator + "locale" + File.separator + (localeString + ".yml"));
        ...
        switch(locale.version()) {
            ...
            case 6 -> {
                ...
                Locale.WorldMineMessages newWorldMineMessages = new Locale.WorldMineMessages(
                        ...
                        "<red>Failed to unlock block <yellow><block_type></yellow> in mine <yellow><mine_id></yellow> do to invalid plugin settings.</red>",
                        "<red>Failed to unlock block <yellow><block_type></yellow> in mine <yellow><mine_id></yellow> do to no LuckPerms' user found.</red>",
                        "<red>Failed to unlock block <yellow><block_type></yellow> in mine <yellow><mine_id></yellow> do to being excluded from unlocking blocks.</red>",
                        oldWorldMineMessages.blockLocked(),
                        oldWorldMineMessages.blocksLocked(),
                        oldWorldMineMessages.playerBlockUnlocked(),
                        "<red>Unable to unlock block <yellow><block_type></yellow> for player <yellow><player></yellow> in mine <yellow><mine_id></yellow> due to invalid plugin settings.</red>",
                        "<red>Unable to unlock block <yellow><block_type></yellow> for player <yellow><player></yellow> in mine <yellow><mine_id></yellow> due to no LuckPerms' user found.</red>",
                        "<red>Unable to unlock block <yellow><block_type></yellow> for player <yellow><player></yellow> in mine <yellow><mine_id></yellow> due to the player having an excluded group.</red>",
                        oldWorldMineMessages.playerBlockLocked(),
                        oldWorldMineMessages.playerBlocksLocked(),
                        ...
                        oldWorldMineMessages.notEnoughCurrency(),
                        oldWorldMineMessages.blockNotPurchasable(),
                        oldWorldMineMessages.guiErrorNotInMine(),
                        oldWorldMineMessages.moneyCurrencyName(),
                        oldWorldMineMessages.playerPointsCurrencyName());
            ...
            case 3 -> {
                logger.warn(AdventureUtility.plain("Version 3 of the locale configuration requires manual migration!"));
                logger.warn(AdventureUtility.plain("You should take a backup of your existing locale configuration and regenerate your en_US.yml locale configuration."));
                logger.warn(AdventureUtility.plain("You can then make any changes from there. The default locale configuration will be used in the meantime."));
                return null;
            }

            default -> {
                logger.warn(AdventureUtility.plain("Failed to migrate your locale configuration. Please update to the newest version or regenerate your locale file. The default locale will be used."));
                return null;
            }
        }
    }
    ...
    public boolean validateConfiguration(@Nullable Locale configuration) {
        if(configuration == null) {
            logger.warn(AdventureUtility.plain("Unable to validate locale as the locale configuration failed to load. The default locale will be used."));
            return false;
        }
        ...
        if(configuration.prefix() == null
            ...
            logger.warn(AdventureUtility.plain("One of the plugin's locale messages is null. Double-check your configuration. The default locale will be used."));
        ...
        if(packetMessages.mineTimeChanged() == null
            ...
            logger.warn(AdventureUtility.plain("One of the plugin's packet mine locale messages is null. Double-check your configuration. The default locale will be used."));
            this.configuration = null;
            return false;
        }
        ...
        if(worldMineMessages.invalidBlockType() == null
            ...
            logger.warn(AdventureUtility.plain("One of the plugin's world mine locale messages is null. Double-check your configuration. The default locale will be used."));
            this.configuration = null;
            return false;
        }
        ...
        if(timeMessage.prefix() == null
            ...
            logger.warn(AdventureUtility.plain("One of the plugin's time message locale messages is null. Double-check your configuration. The default locale will be used."));
            this.configuration = null;
            return false;
        }
    ...
    public String getTimeMessage(long timeSeconds) {
        ...
        return AdventureUtility.serialize(AdventureUtility.deserialize(stringBuilder.toString(), placeholders));
    }
