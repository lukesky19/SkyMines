...
*/
package com.github.lukesky19.skymines.listeners.connection;
...
public class PlayerQuitListener implements Listener {
    ...
    public void onPlayerQuit(PlayerQuitEvent playerQuitEvent) {
        ...
        playerDataManager.savePlayerData(uuid)
                .thenAccept(_ -> playerDataManager.unloadPlayerData(uuid)
                        .thenAccept(_ -> bossBarManager.removeBossBar(player, uuid)));
    }
}
